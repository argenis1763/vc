...
--
-- Servidor: localhost
-- Tiempo de generación: 12-07-2014 a las 03:19:46
...
('College', 'action_essaystudents_index'),
('Estudiante', 'action_essaystudents_index'),
('Tutor', 'action_essaystudents_index'),
('College', 'action_essaystudents_write'),
('Estudiante', 'action_essaystudents_write'),
('Tutor', 'action_essaystudents_write'),
('Analista_I', 'action_essays_admin'),
('College', 'action_essays_admin'),
('Analista_I', 'action_essays_create'),
('College', 'action_essays_create'),
('College', 'action_essays_delete'),
('Analista_I', 'action_essays_generate'),
('College', 'action_essays_generate'),
('Analista_I', 'action_essays_index'),
('College', 'action_essays_index'),
('Analista_I', 'action_essays_list'),
('College', 'action_essays_list'),
('Analista_I', 'action_essays_remove'),
('College', 'action_essays_remove'),
('Analista_I', 'action_essays_update'),
('College', 'action_essays_update'),
('Analista_I', 'action_essays_view'),
('College', 'action_essays_view'),
...
('Analista_I', 'action_parents_admin'),
('College', 'action_parents_admin'),
('Analista_I', 'action_parents_index'),
('College', 'action_parents_index'),
('Analista_I', 'action_parents_remove'),
('College', 'action_parents_remove'),
('College', 'action_parents_update'),
('Analista_I', 'action_parents_view'),
('College', 'action_parents_view'),
...
('Analista_I', 'action_students_admin'),
('College', 'action_students_admin'),
('Analista_I', 'action_students_index'),
('College', 'action_students_index'),
('Analista_I', 'action_students_remove'),
('College', 'action_students_remove'),
('Analista_I', 'action_students_update'),
('College', 'action_students_update'),
('Analista_I', 'action_students_view'),
('College', 'action_students_view'),
('Analista_I', 'action_tutor_admin'),
('College', 'action_tutor_admin'),
('Analista_I', 'action_tutor_index'),
('College', 'action_tutor_index'),
('Analista_I', 'action_tutor_remove'),
('College', 'action_tutor_remove'),
('Analista_I', 'action_tutor_update'),
('College', 'action_tutor_update'),
('Analista_I', 'action_tutor_view'),
('College', 'action_tutor_view'),
...
('Analista_I', 'action_users_admin'),
('College', 'action_users_admin'),
('Analista_I', 'action_zones_admin'),
('College', 'action_zones_admin'),
('Analista_I', 'action_zones_create'),
('College', 'action_zones_create'),
('College', 'action_zones_delete'),
('Analista_I', 'action_zones_index'),
('College', 'action_zones_index'),
('Analista_I', 'action_zones_update'),
('College', 'action_zones_update'),
('Analista_I', 'action_zones_view'),
